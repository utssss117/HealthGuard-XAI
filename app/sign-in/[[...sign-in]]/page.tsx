  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] bg-[#020617] px-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[500px] pointer-events-none opacity-10">
        <div className="absolute top-0 right-0 w-80 h-80 bg-[#6c47ff] rounded-full blur-[100px]"></div>
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#8b5cf6] rounded-full blur-[100px]"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="text-center mb-10">
          ...
          <p className="text-[#94a3b8] mt-2">Access your clinical insights & risk profiles</p>
        </div>
